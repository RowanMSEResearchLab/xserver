...
ACLOCAL = ${SHELL} /home/geebz/xserver/missing --run aclocal-1.11
...
AR = ar
AS = as
AUTOCONF = ${SHELL} /home/geebz/xserver/missing --run autoconf
AUTOHEADER = ${SHELL} /home/geebz/xserver/missing --run autoheader
AUTOMAKE = ${SHELL} /home/geebz/xserver/missing --run automake-1.11
AWK = mawk
...
DEFAULT_LOGDIR = 
DEFAULT_LOGPREFIX = /usr/var/log/Xorg.
DEFAULT_MODULE_PATH = /usr/lib/xorg/modules
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DGA_CFLAGS =  
DGA_LIBS =  
DIX_CFLAGS = -DHAVE_DIX_CONFIG_H $(CWARNFLAGS) -fno-strict-aliasing -D_BSD_SOURCE -DHAS_FCHOWN -DHAS_STICKY_DIR_BIT -I/usr/include/pixman-1 -I/usr/include/libdrm -I/usr/include/freetype2 -I/usr/include/X11/dri   -I$(top_srcdir)/include -I$(top_builddir)/include -I$(top_srcdir)/Xext -I$(top_srcdir)/composite -I$(top_srcdir)/damageext -I$(top_srcdir)/xfixes -I$(top_srcdir)/Xi -I$(top_srcdir)/mi -I$(top_srcdir)/miext/sync -I$(top_srcdir)/miext/shadow  -I$(top_srcdir)/miext/damage -I$(top_srcdir)/render -I$(top_srcdir)/randr -I$(top_srcdir)/fb -I$(top_srcdir)/dbe -fvisibility=hidden
DIX_LIB = $(top_builddir)/dix/libdix.la
DLLTOOL = dlltool
DLOPEN_LIBS = -ldl
DMXEXAMPLES_DEP_CFLAGS =  
DMXEXAMPLES_DEP_LIBS = -ldmx -lXext -lX11  
DMXMODULES_CFLAGS =  
DMXMODULES_LIBS = -lXmuu -lXext -lXrender -lX11 -lXfixes -lXi -lXau -lXdmcp  
DMXXIEXAMPLES_DEP_CFLAGS =  
DMXXIEXAMPLES_DEP_LIBS = -ldmx -lXi -lXext -lX11  
DMXXMUEXAMPLES_DEP_CFLAGS =  
DMXXMUEXAMPLES_DEP_LIBS = -ldmx -lXmu -lXt -lXext -lX11  
DOXYGEN = 
DRI2PROTO_CFLAGS =  
DRI2PROTO_LIBS =  
...
MAKEINFO = ${SHELL} /home/geebz/xserver/missing --run makeinfo
MANIFEST_TOOL = :
...
SDK_REQUIRED_MODULES = xproto >= 7.0.22 randrproto >= 1.4.0 renderproto >= 0.11 xextproto >= 7.1.99 inputproto >= 2.1.99.6 kbproto >= 1.0.3 fontsproto pixman-1 >= 0.21.8 videoproto xf86driproto >= 2.1.0 glproto >= 1.4.16 dri >= 7.8.0 dri2proto >= 2.8 xineramaproto pciaccess >= 0.12.901
SED = /bin/sed
SELINUX_CFLAGS = 
SELINUX_LIBS = 
...
X11EXAMPLES_DEP_LIBS = -lXext -lX11  
XDMCP_CFLAGS =  
XDMCP_LIBS = -lXdmcp  
...
XDMX_SYS_LIBS = -lXmuu -lXext -lXrender -lX11 -lXfixes -lXi -lXau -lXdmcp  
XEPHYR_CFLAGS = 
XEPHYR_INCS = 
XEPHYR_LIBS = 
...
XNEST_SYS_LIBS = -lXext -lX11 -lXau -lXdmcp    -lpthread
XORG_CFLAGS =  -DHAVE_XORG_CONFIG_H -fvisibility=hidden   -I/usr/include/libdrm   -DXF86PM  
XORG_DRIVER_LIBS = 
...
XORG_SYS_LIBS =  -lpciaccess    -lpthread -ldrm    
XPBPROXY_CFLAGS = 
XPBPROXY_LIBS = 
XQUARTZ_LIBS = 
XQUARTZ_SPARKLE = no
XRESEXAMPLES_DEP_CFLAGS =  
XRESEXAMPLES_DEP_LIBS = -lXRes -lXext -lX11  
XSERVERCFLAGS_CFLAGS = -D_BSD_SOURCE -DHAS_FCHOWN -DHAS_STICKY_DIR_BIT -I/usr/include/pixman-1 -I/usr/include/libdrm -I/usr/include/freetype2 -I/usr/include/X11/dri  
...
XTSTEXAMPLES_DEP_LIBS = -lXtst -lXext -lX11  
...
abi_videodrv = 13.0
abi_xinput = 18.0
abs_builddir = /home/geebz/xserver
abs_srcdir = /home/geebz/xserver
abs_top_builddir = /home/geebz/xserver
abs_top_srcdir = /home/geebz/xserver
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/geebz/xserver/install-sh
